const obtainInstructionNode = document.querySelector("#steak");
...
.then((response) => {
  response.map((cadaPasoDeLaReceta)=>{

     document.querySelector("#brusselsSprouts").innerHTML += `<li>${cadaPasoDeLaReceta}</li>`
